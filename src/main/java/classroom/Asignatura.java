...
public class Asignatura {
	 String nombre;
	    ...
	    Asignatura(long codigoExterno,Tipo tipo) {
	    ...
	    Asignatura(String nombre, int codigoInterno, long codigoExterno,Tipo tipo) {
	        this.nombre = nombre;
	    ...
	    void cambiarDatos(int codigoInterno, long codigoExterno, String nombre,Tipo tipo) {
	        this.codigoInterno = codigoInterno;
	        this.codigoExterno = codigoExterno;
	        this.nombre = nombre;
	        this.tipo = tipo;
